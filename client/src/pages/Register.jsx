...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0c0f1a] flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-600/5 dark:bg-blue-600/10 rounded-full blur-[120px] mix-blend-screen pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-600/5 dark:bg-indigo-600/10 rounded-full blur-[120px] mix-blend-screen pointer-events-none"></div>
      ...
      <div className="w-full max-w-md my-8">
        ...
        <div className="glass-card rounded-3xl p-8 border border-gray-200 dark:border-white/5 relative z-10 shadow-sm dark:shadow-none">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-8">Join the future of banking today</p>
